...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3">Master Pelatihan</h1>

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title mb-0">Semua Pelatihan</h5>
                    <div class="btn-group mb-3" role="group" aria-label="Default button group">
                        <a href="{{ route('admin.pelatihan.create') }}" class="btn btn-primary">Tambah Data</a>
                    </div>
                </div>
                <div class="card-body">
                    {{-- Start Table --}}
                    <div class="table-responsive">
                        <table class="table table-hover my-0" id="tbl_pelatihan">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th class="d-none d-xl-table-cell">Pelatihan</th>
...
@push('custom-script')
    <script type="text/javascript">
        $(function () {
            var table = $('#tbl_pelatihan').DataTable({
                language: {
                    search: 'Cari:',
