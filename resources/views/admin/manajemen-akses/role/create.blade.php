        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Form Role dan Permission</h5>
                </div>
                <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-row align-items-center flex-wrap gap-4">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="permissions[]" type="checkbox" role="switch" id="flexSwitchCheckChecked" value="{{ $item->name }}" checked>
