    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                        <form action="{{ route('eksternal.admin.usulan-ujikom.update', Crypt::encryptstring($usulanUjikom->id)) }}" method="POST">
                            @csrf
                            @method('PUT')
                                <div class="mb-3">
                                ...
                                <div class="mb-3 d-flex justify-content-end gap-1">
                                    <a href="{{ route('eksternal.admin.usulan-ujikom.index') }}" class="btn btn-link shadow-none" role="button">Batal</a>
