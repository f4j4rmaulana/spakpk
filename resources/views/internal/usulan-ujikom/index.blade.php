            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="btn-group mb-3 d-flex gap-2" role="group" aria-label="Default button group">
                        <a href="{{ route('internal.usulan-ujikom.create') }}" class="btn btn-primary">Buat Usulan Uji Kompetensi</a>
                    </div>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#tbl_usulan_ujikom').DataTable({
                ...
                responsive: true,
                paging: true,
                ajax: "{{ route('internal.usulan-ujikom.ajax') }}",
                columns: [
