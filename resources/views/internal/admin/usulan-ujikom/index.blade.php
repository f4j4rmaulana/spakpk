...
<div class="container-fluid p-0">
    ...
    <div class="row">
        ...
        {{-- Start Data Usulan Uji Kompetensi --}}
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="btn-group mb-3 d-flex gap-2" role="group" aria-label="Default button group">
                        <a href="{{ route('internal.admin.usulan-ujikom.create') }}" class="btn btn-primary">Buat Usulan Uji Kompetensi</a>
                    </div>
        ...
        {{-- End Data Usulan Uji Kompetensi --}}
    </div>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#tbl_usulan_ujikom').DataTable({
                ...
                responsive: true,
                paging: true,
                ajax: "{{ route('internal.admin.usulan-ujikom.ajax') }}",
                columns: [
