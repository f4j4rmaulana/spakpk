    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                        <form action="{{ route('internal.admin.usulan-pelatihan.store') }}" method="POST">
                            @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3 d-flex justify-content-end gap-1">
                                    <a href="{{ route('internal.admin.usulan-pelatihan.index') }}" class="btn btn-link shadow-none" role="button">Batal</a>
...
<script>
    $(document).ready(function(){
        $('#user_id').select2({
            ...
            ajax:{
                url:route('internal.admin.usulan-pelatihan.ajaxGetUsers'),
                dataType:'json',
                data: (params) => {
                    let query = {
                        search: params.term,
...
<script>
    $(document).ready(function(){
        $('#jenis_pelatihan_id').select2({
            ...
            // placeholder:'Pilih Pengusul',
            ajax:{
                url:route('internal.admin.usulan-pelatihan.ajaxGetJenisPelatihan'),
                dataType:'json',
                processResults:data=>{
                    return {
...
{{-- <script>
    $(document).ready(function(){
        ...
        $('#jenis_pelatihan_id').select2({
            ...
            ajax: {
                url: route('internal.admin.usulan-pelatihan.ajaxGetJenisPelatihan'), // Ubah dengan URL yang sesuai
                dataType: 'json',
...
<script>
    $(document).ready(function(){
        $('#pelatihan_id').select2({
            ...
            // placeholder:'Pilih Pengusul',
            ajax:{
                url:route('internal.admin.usulan-pelatihan.ajaxGetPelatihan'),
                dataType:'json',
                processResults:data=>{
                    return {
                        results:data.map(res=>{
