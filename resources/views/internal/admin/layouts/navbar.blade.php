        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
                <div class="dropdown-menu-footer d-flex justify-content-between">
                    <div class="text-dark notifHeader">Notifikasi ({{ auth()->user()->unreadNotifications->count() }})</div>
                    <a href="javascript:void(0)" data-url="{{ route('internal.admin.notifikasi.ajaxReadAll') }}" class="text-muted btnReadAll">Tandai semua dibaca</a>
                </div>
                <div class="list-group notifMessage">
                    @foreach(auth()->user()->unreadNotifications as $notification)
                        <a href="javascript:void(0)" data-url="{{ route('internal.admin.notifikasi.ajaxRead', Crypt::encryptString($notification->id)); }}"  class="list-group-item btnRead">
                ...
                <div class="dropdown-menu-footer">
                    <a href="{{ route('internal.admin.notifikasi.index') }}" class="text-muted">Tampilkan semua notifikasi</a>
                </div>
            </div>
        </li>
